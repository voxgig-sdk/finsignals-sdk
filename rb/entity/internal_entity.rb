...
class InternalEntity
  ...
  def make
    opts = @_entopts.dup
    InternalEntity.new(@_client, opts)
  end
  ...
  # @return [Internal, Hash] the current Internal data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Internal fields)
  def match_get
  ...
  #
  # @param reqdata [InternalCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Internal, Hash] the created Internal; raises FinsignalsError on failure
