...
class ClassifyEntity
  ...
  def make
    opts = @_entopts.dup
    ClassifyEntity.new(@_client, opts)
  end
  ...
  # @return [Classify, Hash] the current Classify data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Classify fields)
  def match_get
  ...
  #
  # @param reqdata [ClassifyCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Classify, Hash] the created Classify; raises FinsignalsError on failure
