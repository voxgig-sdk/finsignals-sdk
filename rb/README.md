...
The Ruby SDK for the Finsignals API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `FinsignalsError` (a `StandardError` subclass), so wrap
