...
module FinsignalsTestRunner
  ...
  def self.env_override(m)
    live = getenv("FINSIGNALS_TEST_LIVE")
    override = getenv("FINSIGNALS_TEST_OVERRIDE")
    ...
    explain = getenv("FINSIGNALS_TEST_EXPLAIN")
    m["FINSIGNALS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = FinsignalsTestRunner
Helpers = FinsignalsHelpers
Vs = VoxgigStruct
