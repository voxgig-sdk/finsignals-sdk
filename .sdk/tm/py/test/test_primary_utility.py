...
from projectname_sdk import FinsignalsSDK
from projectname_sdk.core.spec import FinsignalsSpec
from projectname_sdk.core.result import FinsignalsResult
from projectname_sdk.core.response import FinsignalsResponse
from projectname_sdk.core.operation import FinsignalsOperation
from projectname_sdk.core.error import FinsignalsError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FinsignalsBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return FinsignalsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = FinsignalsSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = FinsignalsSDK.test(None, None)
        ...
        class TestInitFeature(FinsignalsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FinsignalsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FinsignalsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FinsignalsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FinsignalsSDK.test(None, setup_opts)
