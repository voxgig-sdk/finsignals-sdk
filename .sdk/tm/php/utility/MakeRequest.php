...
// Finsignals SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FinsignalsMakeRequest
{
    public static function call(FinsignalsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FinsignalsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FinsignalsResponse($fetched);
        } else {
