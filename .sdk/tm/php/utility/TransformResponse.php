...
// Finsignals SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class FinsignalsTransformResponse
{
    public static function call(FinsignalsContext $ctx): mixed
    {
        ...
        $transform = FinsignalsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
