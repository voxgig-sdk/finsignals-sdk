...
// Finsignals SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FinsignalsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FinsignalsOmni::structfix($now, Struct::undef()))
                        !== json_encode(FinsignalsOmni::structfix($val, Struct::undef()))) {
