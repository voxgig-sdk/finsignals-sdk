...
// Finsignals SDK ratelimit feature
...
class FinsignalsRatelimitFeature extends FinsignalsBaseFeature
{
    ...
    private function _acquire(FinsignalsContext $ctx): void
    {
    ...
    private function _track(FinsignalsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
