...
// Finsignals SDK streaming feature
...
class FinsignalsStreamingFeature extends FinsignalsBaseFeature
{
    ...
    private function _iterate(FinsignalsResult $result): \Generator
    {
    ...
    private function _streamable(FinsignalsContext $ctx): bool
    {
