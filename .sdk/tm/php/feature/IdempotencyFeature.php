...
// Finsignals SDK idempotency feature
...
class FinsignalsIdempotencyFeature extends FinsignalsBaseFeature
{
    ...
    private function _mutating(FinsignalsContext $ctx): bool
    {
