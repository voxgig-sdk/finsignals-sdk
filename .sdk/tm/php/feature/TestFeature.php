...
// Finsignals SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FinsignalsTestFeature extends FinsignalsBaseFeature
{
    ...
    public function init(FinsignalsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FinsignalsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FinsignalsParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FinsignalsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FinsignalsContext $ctx, $op, $args): array
    {
