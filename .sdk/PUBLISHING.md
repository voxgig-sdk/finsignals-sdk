...
|---|---|---|
| `ts/` | @voxgig-sdk/finsignals-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/finsignals-sdk \
      --repository voxgig-sdk/finsignals-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/finsignals-sdk` shows it, and
`npm trust revoke @voxgig-sdk/finsignals-sdk --id=<id>` removes it.
