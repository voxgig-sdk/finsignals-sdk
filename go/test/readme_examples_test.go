...
const testSeed = `map[string]any{"entity": map[string]any{"classify": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "health": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "internal": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rotation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "usage": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
