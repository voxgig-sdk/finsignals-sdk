...
func NewClassifyEntity(client *core.FinsignalsSDK, entopts map[string]any) *ClassifyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClassifyEntity) GetName() string { return e.name }
...
func (e *ClassifyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClassifyEntity) Deleted() bool {
	return e.deleted
}


func (e *ClassifyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClassifyEntity(e.client, opts)
}

func (e *ClassifyEntity) Data(args ...any) any {
...
func (e *ClassifyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Classify; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ClassifyEntity) DataTyped(data ...Classify) Classify {
	if len(data) > 0 {
		return typedFrom[Classify](e.Data(asMap(data[0])))
	}
	return typedFrom[Classify](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Classify (all fields
// optional at the wire level).
func (e *ClassifyEntity) MatchTyped(match ...Classify) Classify {
	if len(match) > 0 {
		return typedFrom[Classify](e.Match(asMap(match[0])))
	}
	return typedFrom[Classify](e.Match())
}
...
func (e *ClassifyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClassifyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ClassifyEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ClassifyEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ClassifyCreateData and returns an Classify. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ClassifyEntity) CreateTyped(reqdata ClassifyCreateData, ctrl map[string]any) (Classify, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Classify{}, err
	}
	return typedFrom[Classify](res), nil
}



func (e *ClassifyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ClassifyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ClassifyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
