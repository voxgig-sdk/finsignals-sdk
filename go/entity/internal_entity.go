...
func NewInternalEntity(client *core.FinsignalsSDK, entopts map[string]any) *InternalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *InternalEntity) GetName() string { return e.name }
...
func (e *InternalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *InternalEntity) Deleted() bool {
	return e.deleted
}


func (e *InternalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewInternalEntity(e.client, opts)
}

func (e *InternalEntity) Data(args ...any) any {
...
func (e *InternalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Internal; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *InternalEntity) DataTyped(data ...Internal) Internal {
	if len(data) > 0 {
		return typedFrom[Internal](e.Data(asMap(data[0])))
	}
	return typedFrom[Internal](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Internal (all fields
// optional at the wire level).
func (e *InternalEntity) MatchTyped(match ...Internal) Internal {
	if len(match) > 0 {
		return typedFrom[Internal](e.Match(asMap(match[0])))
	}
	return typedFrom[Internal](e.Match())
}
...
func (e *InternalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *InternalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *InternalEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *InternalEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// InternalCreateData and returns an Internal. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *InternalEntity) CreateTyped(reqdata InternalCreateData, ctrl map[string]any) (Internal, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Internal{}, err
	}
	return typedFrom[Internal](res), nil
}



func (e *InternalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *InternalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *InternalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
