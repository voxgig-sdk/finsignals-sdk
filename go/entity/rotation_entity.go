...
func NewRotationEntity(client *core.FinsignalsSDK, entopts map[string]any) *RotationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RotationEntity) GetName() string { return e.name }
...
func (e *RotationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RotationEntity) Deleted() bool {
	return e.deleted
}


func (e *RotationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRotationEntity(e.client, opts)
}

func (e *RotationEntity) Data(args ...any) any {
...
func (e *RotationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rotation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RotationEntity) DataTyped(data ...Rotation) Rotation {
	if len(data) > 0 {
		return typedFrom[Rotation](e.Data(asMap(data[0])))
	}
	return typedFrom[Rotation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rotation (all fields
// optional at the wire level).
func (e *RotationEntity) MatchTyped(match ...Rotation) Rotation {
	if len(match) > 0 {
		return typedFrom[Rotation](e.Match(asMap(match[0])))
	}
	return typedFrom[Rotation](e.Match())
}
...
func (e *RotationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RotationEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RotationLoadMatch and returns an Rotation. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RotationEntity) LoadTyped(reqmatch RotationLoadMatch, ctrl map[string]any) (Rotation, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Rotation{}, err
	}
	return typedFrom[Rotation](res), nil
}



func (e *RotationEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RotationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RotationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RotationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RotationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
