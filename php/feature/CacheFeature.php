...
class FinsignalsCacheFeature extends FinsignalsBaseFeature
{
    ...
    private function _through(FinsignalsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
