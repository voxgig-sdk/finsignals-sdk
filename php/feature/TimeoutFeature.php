...
// Finsignals SDK timeout feature
...
class FinsignalsTimeoutFeature extends FinsignalsBaseFeature
{
    ...
    private function _with_timeout(FinsignalsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FinsignalsContext $_ctx, float $ms): void
    {
        $client = $this->client;
