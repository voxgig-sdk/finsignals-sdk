...
// Finsignals SDK clienttrack feature
...
class FinsignalsClienttrackFeature extends FinsignalsBaseFeature
{
    ...
    public function PostConstruct(FinsignalsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Finsignals-SDK';
