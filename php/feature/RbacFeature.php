...
class FinsignalsRbacFeature extends FinsignalsBaseFeature
{
    ...
    private function _required(FinsignalsContext $ctx): ?string
    {
    ...
    private function _reject(FinsignalsContext $ctx, string $required): void
    {
    ...
    private function _track(FinsignalsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
