...
// Finsignals SDK telemetry feature
...
class FinsignalsTelemetryFeature extends FinsignalsBaseFeature
{
    ...
    private function _close(FinsignalsContext $ctx, bool $ok): void
    {
