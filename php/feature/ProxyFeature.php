...
class FinsignalsProxyFeature extends FinsignalsBaseFeature
{
    ...
    public function init(FinsignalsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FinsignalsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
