...
// Finsignals SDK Classify entity
...
class ClassifyEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ClassifyEntity($this->_client, $opts);
    }

    /**
     * @param Classify|array $args Classify data (assoc-array) to store.
     */
    ...
    /**
     * @return Classify|array The current Classify data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Classify fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Classify fields).
     */
     ...
     *
     * @param ClassifyCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ClassifyCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Classify|array The created Classify as an assoc-array at the
