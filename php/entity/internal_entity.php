...
// Finsignals SDK Internal entity
...
class InternalEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InternalEntity($this->_client, $opts);
    }

    /**
     * @param Internal|array $args Internal data (assoc-array) to store.
     */
    ...
    /**
     * @return Internal|array The current Internal data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Internal fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Internal fields).
     */
     ...
     *
     * @param InternalCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed InternalCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Internal|array The created Internal as an assoc-array at the
