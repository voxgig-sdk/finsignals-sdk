...
class FinsignalsTestRunner
{
    ...
    {
        $live = self::getenv('FINSIGNALS_TEST_LIVE');
        $override = self::getenv('FINSIGNALS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('FINSIGNALS_TEST_EXPLAIN');
...
class_alias('FinsignalsTestRunner', 'Runner');
class_alias('FinsignalsHelpers', 'Helpers');
