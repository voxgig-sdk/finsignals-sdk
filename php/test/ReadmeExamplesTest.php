...
// Finsignals SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FinsignalsSDK::test)
...
{
    private const SDK_CLASS = 'FinsignalsSDK';
    ...
    private const SDK_BASE = 'finsignals_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../finsignals_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
