...
// Finsignals SDK utility: fetcher

class FinsignalsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FinsignalsSDK/1.0)';
    ...
    public static function call(FinsignalsContext $ctx, string $fullurl, array $fetchdef): array
    {
