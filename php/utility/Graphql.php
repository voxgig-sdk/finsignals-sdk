...
// Finsignals SDK utility: graphql
//
...
class FinsignalsGraphql
{
    ...
    // equivalent.
    public static function body(FinsignalsContext $ctx): mixed
    {
    ...
    public static function errors(FinsignalsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
