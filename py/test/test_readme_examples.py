# Finsignals SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FinsignalsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FinsignalsSDK(...) and FinsignalsSDK.test(...) become
#      FinsignalsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "finsignals_sdk"
_SDK_CLASS = "FinsignalsSDK"
