...
class InternalEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return InternalEntity(self._client, opts)
    ...
    def create(self, reqdata: InternalCreateData, ctrl=None) -> Internal:
        utility = self._utility
