...
class ClassifyEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ClassifyEntity(self._client, opts)
    ...
    def create(self, reqdata: ClassifyCreateData, ctrl=None) -> Classify:
        utility = self._utility
