# Finsignals Python SDK Reference

Complete API reference for the Finsignals Python SDK.
...
#### `FinsignalsSDK.test(testopts=None, sdkopts=None)`
...
Create a new `ClassifyEntity` instance. Pass `None` for no initial data.
...
Create a new `InternalEntity` instance. Pass `None` for no initial data.

#### `Rotation(data=None)`

Create a new `RotationEntity` instance. Pass `None` for no initial data.
...
Create a new `ClassifyEntity` instance with the same options.
...
Create a new `InternalEntity` instance with the same options.
...
Create a new `RotationEntity` instance with the same options.
