...
func registerSDKWords(r *eng.Registry, client *sdk.FinsignalsSDK) {
...
func runOp(client *sdk.FinsignalsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
