...
(0, node_test_1.describe)('RotationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FinsignalsSDK({
    ...
    (0, node_test_1.test)('direct-load-rotation', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-rotation', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FINSIGNALS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FinsignalsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FINSIGNALS_TEST_ROTATION_ENTID'];
    ...
    const client = new __1.FinsignalsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RotationDirect.test.js.map