...
function envOverride(m) {
    if ('TRUE' === process.env.FINSIGNALS_TEST_LIVE ||
        'TRUE' === process.env.FINSIGNALS_TEST_OVERRIDE) {
    ...
    m.FINSIGNALS_TEST_EXPLAIN = process.env.FINSIGNALS_TEST_EXPLAIN || m.FINSIGNALS_TEST_EXPLAIN;
    return m;
}
