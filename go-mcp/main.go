// Command Finsignals-mcp is an MCP server exposing the Finsignals
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Finsignals_list  — list records of an entity
//	Finsignals_load  — load a single record of an entity
//
