...
local SDK_MODULE = "finsignals_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["classify"] = { ["test01"] = { id = "test01" } }, ["health"] = { ["test01"] = { id = "test01" } }, ["internal"] = { ["test01"] = { id = "test01" } }, ["rotation"] = { ["test01"] = { id = "test01" } }, ["usage"] = { ["test01"] = { id = "test01" } } } }'
