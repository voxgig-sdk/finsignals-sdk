...
describe("RotationDirect", function()
  it("should direct-load-rotation", function()
    local setup = rotation_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rotation", setup.live and "live" or "unit")
...
function rotation_direct_setup(mockres)
